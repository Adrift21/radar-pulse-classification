...
gaps reflect standard, untuned representations. Finally, the significance analysis
in Section~V accounts for test-set sampling; the multi-seed study
(Table~\ref{tab:main}) is what bounds training-time variance, and the fine-grained
ordering among the strong configurations should be read in that light.
